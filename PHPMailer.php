...
class PHPMailer {
    ...
    public function __construct($exceptions = false, $config) {
        ...
        $this->Helo       = '';
        $this->PluginDir  = '';
        $this->Mailer     = $config['phpmailer.mailer'];
        $this->TimeOut    = $config['phpmailer.timeout'];
        $this->SMTPSecure = $config['phpmailer.smtpsecure'];

        $this->From      = $config['phpmailer.from'];
        $this->FromName  = $config['phpmailer.fromname'];
        $this->Host      = $config['phpmailer.host'];
        $this->Port      = $config['phpmailer.port'];
        $this->SMTPAuth  = $config['phpmailer.smtpauth'];
        $this->SMTPDebug = $config['phpmailer.smtpdebug'];
    ...
    public function EncodeQ($str, $position = 'text') {
        ...
        switch (strtolower($position)) {
            case 'phrase':
                ...
                $search = "/([^A-Za-z0-9!*+\/ -])/";
                $encoded = preg_replace_callback($search, function($matches) {
